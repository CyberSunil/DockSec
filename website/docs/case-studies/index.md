...
| --- | --- | --- | --- |
| [1](/docs/case-studies/node-18) | `node:18` | 2,200 | Triage: 9 CVEs deserve attention today, not 2,200 |
| [2](/docs/case-studies/python-slim) | `python:3.12-slim` | 44 | A well-maintained image with nothing you can fix |
| [3](/docs/case-studies/nginx-alpine) | `nginx:1.31.6-alpine` | 0 | What a clean result looks like, and what it does not prove |
