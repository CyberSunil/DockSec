---
title: "nginx:alpine - a clean result"
sidebar_position: 3
---
...
- **Not "your application is safe".** Nothing here scanned your code, your
  ...
  deployment - see
  [`examples/compose/docker-compose-insecure.yml`](https://github.com/OWASP/DockSec/tree/main/examples/compose/docker-compose-insecure.yml).
