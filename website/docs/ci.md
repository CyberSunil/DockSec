...
| System | Guide |
| --- | --- |
| GitHub Actions | [README](https://github.com/OWASP/DockSec/blob/main/README.md#5-or-run-the-container-image-nothing-to-install) |
| Jenkins | [jenkins.md](https://github.com/OWASP/DockSec/blob/main/docs/ci/jenkins.md) |
| GitLab CI | [gitlab.md](https://github.com/OWASP/DockSec/blob/main/docs/ci/gitlab.md) |
| Azure Pipelines | [azure-pipelines.md](https://github.com/OWASP/DockSec/blob/main/docs/ci/azure-pipelines.md) |
| pre-commit | [pre-commit.md](https://github.com/OWASP/DockSec/blob/main/docs/ci/pre-commit.md) |
...
need them to; see [Configuration file](https://github.com/OWASP/DockSec/blob/main/README.md#configuration-file).
