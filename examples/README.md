...
the right answer here. See [`docs/rules/`](../docs/rules/).
...
something. See [`docs/case-studies/python-slim.md`](../docs/case-studies/python-slim.md).

## Config file

[`.docksec.yml`](.docksec.yml) is an annotated repo-level config showing every
supported key.
